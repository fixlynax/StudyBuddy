            ...
            <div class="padding-container">
                <div class="card">
                    ...
                    <form action="reportIssueStudentHandler.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="file" id="pictureIssue" name="pictureIssue" accept="image/*" required>
                        <labelI for="description">Description</labelI>
                        <textarea id="description" name="description" rows="4" placeholder="Enter report description.."
                            required></textarea>
